...
const EditPostForm = () => {
    ...
    const onSave = ()=>{
        EditPost(param.id, {title:title, content:content}).then(()=>navigate('/'))
    }
    ...
    return (
        <div className="w-full flex justify-center pt-[100px]">
            <div className="w-[500px] h-[550px] bg-[#eceeee] rounded-md p-4 relative">
                ...
                <div className="uppercase mb-4">Edit post</div>
                ...
                <input type="text" className="w-[50%] h-9 p-1 pl-2 outline-none mb-4 rounded-sm" placeholder="Enter post title" onChange={onTitleChange} value={title}/>

                <div className='text-gray-500'>Content <span className="text-red-400">*</span></div>
                <textarea className="w-[80%] h-[300px] resize-none outline-none p-2 rounded-sm" placeholder="Enter post content" onChange={onContentChange} value={content} />
